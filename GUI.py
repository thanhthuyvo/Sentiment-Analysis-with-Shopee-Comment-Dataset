...
# ------------- EDA ------------------------
    ...
    data = pd.read_csv("http://khaihoan.gmazi.com/Products_Shopee_comments.csv", delimiter=',')
    ...
    data = pd.read_csv("https://khaihoan.gmazi.com/Products_Shopee_comments.csv", delimiter=',')
